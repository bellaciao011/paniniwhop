    ...
    <header className="w-full flex flex-col items-center sticky top-0 z-50 shadow-md">
      ...
      <div className="w-full bg-[#3d0710] text-white/90 py-1.5 px-4 flex justify-center gap-6 text-xs font-medium border-b border-white/10">
        ...
        <span className="flex items-center gap-1.5">
          ...
          <span className="text-green-300 font-bold">{sold} sold today</span>
        </span>
      </div>
      ...
      <div className="w-full py-2 px-4 flex flex-wrap justify-center gap-x-5 gap-y-1 text-[11px] text-gray-500 bg-white border-b border-gray-100">
        <span className="flex items-center gap-1 font-medium"><Lock className="w-3 h-3 text-green-600" /> 100% Secure Payment</span>
        <span className="flex items-center gap-1 font-medium"><ShieldCheck className="w-3 h-3 text-green-600" /> Protected Purchase</span>
        <span className="flex items-center gap-1 font-medium"><Truck className="w-3 h-3 text-green-600" /> Free Shipping UK</span>
        <span className="flex items-center gap-1 font-medium"><ShieldCheck className="w-3 h-3 text-green-600" /> Official Product</span>
      </div>
    </header>
  );
}
